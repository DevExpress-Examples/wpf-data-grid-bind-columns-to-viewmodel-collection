...
Namespace ColumnsSample
	...
	Public Class EmployeesDataModel
		Public Shared Function GetEmployees() As IList(Of Employee)
			Dim people As New ObservableCollection(Of Employee) _
				From {
					New Employee() With {
						.FirstName = "Bruce",
						.LastName = "Cambell",
						.Cities = New List(Of String)() From {"Kansas City", "Springfield"},
						.StateProvinceName = "Missouri"
					},
					New Employee() With {
						.FirstName = "Cindy",
						.LastName = "Haneline",
						.Cities = New List(Of String)() From {"Oklahoma City", "Tulsa"},
						.StateProvinceName = "Oklahoma"
					},
					New Employee() With {
						.FirstName = "Andrea",
						.LastName = "Deville",
						.Cities = New List(Of String)() From {"Denver", "Colorado Springs"},
						.StateProvinceName = "Colorado"
					},
					New Employee() With {
						.FirstName = "Anita",
						.LastName = "Ryan",
						.Cities = New List(Of String)() From {"Denver", "Aurora"},
						.StateProvinceName = "Colorado"
					}
				}
			Return people
